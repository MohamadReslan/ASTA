...
<body style="background-color: white;margin: 4px">
<div style="display: flex; align-items: center; gap: 6px;justify-content: space-between;width: 100%;">
    ...
    <form method="post" action="user-controller" style="margin: 0">
        <button type="button" name="action" value="Déconnexion" class="btn btn-outline-danger">Déconnexion</button>
    </form>
</div>
<div class="content m-16" style="background-color: white;width: 95%; padding: 20px;margin: 25px">
    ...
    <form method="post" action="user-controller">
        ...
        <div style="display: flex;gap:8px">
            <input type="submit" name="action" value="Ajouter un utilisateur" class="btn btn-primary"/>
            <input type="submit" name="action" value="Utilisateurs archivés" class="btn btn-primary"/>
        </div>
    </form>
</div>
